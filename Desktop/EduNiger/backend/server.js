...
// /api/auth est exclu pour laisser le login accessible sans tenant.
...
app.get('/api', (req, res) => res.json({ message: 'EduNiger API', version: '3.0.0', status: 'active' }));
...
app.listen(PORT, () => {
  console.log('===========================================');
  console.log(`🚀  EduNiger API v3 SaaS — http://localhost:${PORT}/api`);
  console.log('===========================================');
});
